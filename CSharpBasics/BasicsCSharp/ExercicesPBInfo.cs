...
namespace CSharpBasics.BasicsCSharp
{
    class ExercicesPBInfo
    {
        ...
        //Display the following pyramid of numbers
        public static void Pyramid351(int nrOfLevelsForPyramid)
        {
          ...
          */
            for (int i = 1; i <= nrOfLevelsForPyramid; i++)//iterates the nr. of columns
            {
        ...
        //Display on one line the first nnon-zero natural numbers in ascending order,
        //and on the next line the same numbers, but in descending order.
        ...
        // Function which displayes only 10 numbers on a row
